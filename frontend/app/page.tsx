          ...
          <div className="max-w-4xl">
            <div className="inline-block mb-6">
              <div className="bg-[#ffdc36] text-black px-4 py-2 transform -skew-x-12 inline-block">
                <span className="block transform skew-x-12 tracking-wider text-sm uppercase">
                  Since 1867
                </span>
              </div>
            </div>
            <h1 className="text-white mb-6 leading-tight">
              <span className="block text-6xl sm:text-7xl lg:text-8xl uppercase tracking-tight">
                Glasgow
              </span>
              <span className="block text-6xl sm:text-7xl lg:text-8xl uppercase tracking-tight">
                University
              </span>
              <span className="block text-6xl sm:text-7xl lg:text-8xl uppercase tracking-tight text-[#ffdc36]">
                Boat Club
              </span>
            </h1>
            <div className="h-1 w-32 bg-[#ffdc36] mb-8"></div>
            <p className="text-white text-xl sm:text-2xl mb-12 max-w-2xl">
              Excellence in rowing. Join Scotland&apos;s premier university
              rowing club and become part of our legacy.
            </p>
