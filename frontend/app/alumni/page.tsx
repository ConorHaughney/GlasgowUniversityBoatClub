export default function AlumniPage() {
  return (
    <section id="alumni" className="bg-gray-1000 mt-20">
      <div className="mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <section className="relative py-24 bg-black text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <p className="text-gray-300 text-xl max-w-3xl">
              Stay connected with Glasgow University Boat Club and our alumni community.
            </p>
          </div>
        </section>
        ...
        <div className="mt-10 mb-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-gray-400 text-lg">Alumni content coming soon...</p>
          </div>
        </div>
      </div>
    </section>
